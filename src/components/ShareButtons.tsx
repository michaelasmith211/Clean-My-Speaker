  ...
  const shareLinks = [
    {
      ...
      bgColor: 'bg-[#075E54] hover:bg-[#128C7E] text-white font-medium',
      icon: (
    ...
    },
    {
      ...
      bgColor: 'bg-black hover:bg-slate-900 text-white font-medium border border-slate-700',
      icon: (
    ...
    },
    {
      ...
      bgColor: 'bg-[#0D65D9] hover:bg-[#0b58be] text-white font-medium',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      bgColor: 'bg-sky-700 hover:bg-sky-600 text-white font-medium',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
